      ...
      >
        <Card>
          <div className="text-center py-20">
            <TrendingDown className="mx-auto h-16 w-16 text-gray-300 dark:text-gray-600" />
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-md mx-auto">
              Advanced asset depreciation tracking and reporting features are in development.
            </p>
            <div className="mt-8">
