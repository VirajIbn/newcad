...
import { useAssetTypes, useAssetStatus, useEmployees, useBranches, useDepartments } from '../hooks';
import { dropdownAPI } from '../services/api';
import { useAuth } from '../context/AuthContext';

const AssetFilterForm = ({ onFilter, onClear, loading = false }) => {
  const { user } = useAuth();
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
        ...
        <div className="space-y-1">
          ...
          <SearchableDropdown
            ...
            emptyText={employeesLoading ? "Loading employees..." : "No employees found. Click 'Retry' to reload."}
