...
const AssetDetailsModal = ({ asset, isOpen, onClose, assetStatuses = [], assetConditions = [], orgId }) => {
  ...
  const getConditionText = (conditionId) => {
    if (!assetConditions || !Array.isArray(assetConditions)) return 'Unknown';
    const condition = assetConditions.find(c => c.codeid === conditionId);
    return condition ? condition.codename : 'Unknown';
  };
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                    Asset Details For {asset.assetnumber || 'Unknown Asset'}
                  </h2>
                  <p className="text-gray-600 dark:text-gray-400" style={{ fontSize: '0.8rem' }}>
                    Created By {asset.addedby_name || 'Unknown'} on {asset.addeddate ? formatDateTimeWithAmPm(asset.addeddate) : 'Unknown Date'}, Last Modified By {asset.modifiedby_name || asset.addedby_name || 'Unknown'} on {asset.modifieddate ? formatDateTimeWithAmPm(asset.modifieddate) : (asset.addeddate ? formatDateTimeWithAmPm(asset.addeddate) : 'Unknown Date')}
                  </p>
                </div>
              </div>
              <Button
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-900 dark:text-gray-100">
                      {asset.categoryname || 'Not specified'}
                    </p>
                  </div>
